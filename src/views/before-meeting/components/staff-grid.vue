        ...
        <el-main class="!p-0">
            <b-grid ref="refGrid" v-bind="gridProps" @data="onGridData" @page-change="onPageChange">
                <template #toolbar-left>
                    ...
                    <el-button type="primary" @click="exportStaff">导出</el-button>
                </template>
...
import { getPersonGroupDrop, getStaffRoleDrop } from '~/src/api/common'
import {
    getStaffPage,
...
import dialogEditPanticipate from './dialog-edit-staff.vue'
import dialogSelectPersonnel from './dialog-select-personnel.vue'
import dialogExportStaff from './dialog-export-staff.vue'
...
function getRoleDrop() {
    getStaffRoleDrop({ IncludeUnknown: true, a: 1 }).then((res) => {
